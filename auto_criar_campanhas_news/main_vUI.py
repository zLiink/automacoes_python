"""
Automação de criação e disparo de campanhas no SendPulse.

Interface em Tkinter para cadastrar campanhas (assunto, complemento,
tags, ID da página e horário) e execução automatizada via PyAutoGUI,
incluindo preenchimento, importação de HTML e agendamento.

Requer: pyautogui, pyperclip, tkinter
"""
