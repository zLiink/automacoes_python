...
#Tempo para inicio e entre cmds
pa.PAUSE = 0.7
tempo_inicio = 2
#=============================
...
for dia in range(dias):
    ...
    for i in range(3):
        ...
        encontrar_botao_adc_midia = pa.locateOnScreen(img_add_midia, confidence=0.8)
...
for _ in range(contagem_de_abas):
    ...
    try:
        ...
        print("Erro nao encontrado - Programado com sucesso.")
        sleep(2)
        pos = pa.locateOnScreen(img_programar_azul, confidence=0.7)
